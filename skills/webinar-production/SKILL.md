...
slug: webinar-production
description: "Webinar Production (Marketing) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Webinar Production result | your task result (`webinar-production.md`) |
