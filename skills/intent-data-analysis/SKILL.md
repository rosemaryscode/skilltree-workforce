...
slug: intent-data-analysis
description: "Intent Data Analysis (Intelligence) - job contract, stub; complete before running."
metadata:
...
> **Department:** Intelligence  |  **Autonomy:** `ai-drafts`  |  **Cadence:** TODO
...
| Artifact | Location |
|---|---|
| Intent Data Analysis result | your task result (`intent-data-analysis.md`) |
