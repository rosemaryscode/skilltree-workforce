...
description: "Compliance Calendar (Back Office) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Compliance Calendar result | your task result (`compliance-calendar.md`) |
