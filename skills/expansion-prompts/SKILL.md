...
slug: expansion-prompts
description: "Expansion Prompts (Customer) - job contract, stub; complete before running."
metadata:
  department: customer
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Expansion Prompts result | your task result (`expansion-prompts.md`) |
