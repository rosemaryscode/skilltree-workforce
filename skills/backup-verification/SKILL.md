...
description: "Backup Verification (Operations) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Backup Verification result | your task result (`backup-verification.md`) |
