...
slug: case-study-sourcing
description: "Case Study Sourcing (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Case Study Sourcing result | your task result (`case-study-sourcing.md`) |
