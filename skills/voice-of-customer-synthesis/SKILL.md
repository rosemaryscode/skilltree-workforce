...
description: "Voice Of Customer Synthesis (Intelligence) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Voice Of Customer Synthesis result | your task result (`voice-of-customer-synthesis.md`) |
