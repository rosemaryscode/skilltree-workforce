...
description: "Security Questionnaire (Deals) - job contract, stub; complete before running."
metadata:
  department: deals
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Security Questionnaire result | your task result (`security-questionnaire.md`) |
