...
description: "Community Monitoring (Marketing) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Community Monitoring result | your task result (`community-monitoring.md`) |
