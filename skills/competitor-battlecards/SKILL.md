...
description: "Competitor Battlecards (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Competitor Battlecards result | your task result (`competitor-battlecards.md`) |
