...
description: "Compliance Checklist (Operations) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Compliance Checklist result | your task result (`compliance-checklist.md`) |
