...
description: "Short Form Scripting (Marketing) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Short Form Scripting result | your task result (`short-form-scripting.md`) |
