...
slug: referral-sourcing
description: "Referral Sourcing (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Referral Sourcing result | your task result (`referral-sourcing.md`) |
