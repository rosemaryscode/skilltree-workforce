...
slug: signal-monitoring
description: "Signal Monitoring (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: unattended
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Signal Monitoring result | your task result (`signal-monitoring.md`) |
