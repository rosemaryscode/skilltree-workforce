...
slug: onboarding-handoff
description: "Onboarding Handoff (Deals) - job contract, stub; complete before running."
metadata:
  department: deals
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Onboarding Handoff result | your task result (`onboarding-handoff.md`) |
