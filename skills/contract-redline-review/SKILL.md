...
description: "Contract Redline Review (Deals) - job contract, stub; complete before running."
metadata:
  department: deals
  autonomy: human-led
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Contract Redline Review result | your task result (`contract-redline-review.md`) |
