...
kind: skill
name: "Repurposing Runbook"
slug: repurposing-runbook
description: "Repurposing Runbook (Marketing) - job contract, stub; complete before running."
metadata:
...
> **Department:** Marketing  |  **Autonomy:** `ai-drafts`  |  **Cadence:** TODO
...
| Artifact | Location |
|---|---|
| Repurposing Runbook result | your task result (`repurposing-runbook.md`) |
