...
description: "Competitor Tracking (Intelligence) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Competitor Tracking result | your task result (`competitor-tracking.md`) |
