...
slug: payment-terms-check
description: "Payment Terms Check (Deals) - job contract, stub; complete before running."
metadata:
  department: deals
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Payment Terms Check result | your task result (`payment-terms-check.md`) |
