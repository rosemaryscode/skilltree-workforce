...
slug: bookkeeping-reconciliation
description: "Bookkeeping Reconciliation (Back Office) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Bookkeeping Reconciliation result | your task result (`bookkeeping-reconciliation.md`) |
