...
slug: sequence-writing
description: "Sequence Writing (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Sequence Writing result | your task result (`sequence-writing.md`) |
