...
description: "Knowledge Base Curation (Operations) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Knowledge Base Curation result | your task result (`knowledge-base-curation.md`) |
