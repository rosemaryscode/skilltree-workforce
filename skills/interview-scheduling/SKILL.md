...
description: "Interview Scheduling (Back Office) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Interview Scheduling result | your task result (`interview-scheduling.md`) |
