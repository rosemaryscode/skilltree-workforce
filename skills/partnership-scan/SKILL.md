...
slug: partnership-scan
description: "Partnership Scan (Intelligence) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Partnership Scan result | your task result (`partnership-scan.md`) |
