...
description: "Capacity Planning (Operations) - job contract, stub; complete before running."
metadata:
...
> **Department:** Operations  |  **Autonomy:** `human-led`  |  **Cadence:** TODO
...
| Artifact | Location |
|---|---|
| Capacity Planning result | your task result (`capacity-planning.md`) |
