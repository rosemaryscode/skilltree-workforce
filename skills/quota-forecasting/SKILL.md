...
kind: skill
name: "Quota Forecasting"
slug: quota-forecasting
description: "Quota Forecasting (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: human-led
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Quota Forecasting result | your task result (`quota-forecasting.md`) |
