...
slug: growth-loop-experiments
description: "Growth Loop Experiments (Marketing) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Growth Loop Experiments result | your task result (`growth-loop-experiments.md`) |
