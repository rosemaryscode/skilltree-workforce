...
description: "Vendor Payments (Back Office) - job contract, stub; complete before running."
metadata:
...
> **Department:** Back Office  |  **Autonomy:** `human-led`  |  **Cadence:** TODO
...
| Artifact | Location |
|---|---|
| Vendor Payments result | your task result (`vendor-payments.md`) |
