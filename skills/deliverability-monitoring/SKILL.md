...
description: "Deliverability Monitoring (Sales) - job contract, stub; complete before running."
metadata:
  department: sales
  autonomy: unattended
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Deliverability Monitoring result | your task result (`deliverability-monitoring.md`) |
