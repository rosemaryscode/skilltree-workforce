...
slug: onboarding-paperwork
description: "Onboarding Paperwork (Back Office) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Onboarding Paperwork result | your task result (`onboarding-paperwork.md`) |
