...
description: "Landing Page Testing (Marketing) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Landing Page Testing result | your task result (`landing-page-testing.md`) |
