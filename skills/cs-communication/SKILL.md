...
kind: skill
name: "Cs Communication"
slug: cs-communication
description: "Cs Communication (Customer) - job contract, stub; complete before running."
metadata:
  department: customer
  autonomy: ai-drafts
  frequency: TODO
...
| Artifact | Location |
|---|---|
| Cs Communication result | your task result (`cs-communication.md`) |
