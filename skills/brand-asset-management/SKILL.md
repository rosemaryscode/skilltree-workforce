...
description: "Brand Asset Management (Marketing) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Brand Asset Management result | your task result (`brand-asset-management.md`) |
