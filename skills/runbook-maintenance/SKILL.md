...
description: "Runbook Maintenance (Operations) - job contract, stub; complete before running."
metadata:
...
| Artifact | Location |
|---|---|
| Runbook Maintenance result | your task result (`runbook-maintenance.md`) |
